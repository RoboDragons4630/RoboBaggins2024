...
public class TeleAutoBack extends SequentialCommandGroup {
  /** Creates a new TeleAutoBack. */
  public TeleAutoBack(Launcher s_Launcher, Intake s_Intake, Swerve s_Swerve) {
