...
public class exampleAutoS extends SequentialCommandGroup {
    public exampleAutoS(Swerve s_Swerve){
        ...
        Trajectory exampleTrajectory =
            TrajectoryGenerator.generateTrajectory(
                ...
                // Pass through these two interior waypoints, making an 's' curve path
                                        //1, 0                          //1, 1
               //List.of(new Translation2d(0.8, 0), new Translation2d(1.2, 0), new Translation2d(1.2, 1.6)),
                //                         0.5, 0.75
               List.of(new Translation2d(0.75, 0)),
                ...
                //          0.8, 1.4  
                //          1, 1.3                          -45
                new Pose2d(1.5, 0, Rotation2d.fromDegrees(-120)),
            config);
            /*
