...
public class TeleAutoRight extends SequentialCommandGroup {
  /** Creates a new TeleAutoRight. */
  public TeleAutoRight(Launcher s_Launcher, Intake s_Intake, Swerve s_Swerve) {
